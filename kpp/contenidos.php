...
<body>
    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
            data-background="assets/images/banner/contenidos.jpg">
            <div class="shape2 wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/contenidos.jpg" alt="shape">
            </div>
            <div class="shape1 wow slideInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/contenidos.jpg" alt="shape">
            </div>
            <div class="shape3 wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img class="sway__animationX" src="assets/images/banner/contenidos.jpg" alt="shape">
            </div>
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Contenidos</h2>
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.php">Inicio</a><span><i class="fa-regular fa-angles-right mx-2"></i>Contenidos</span>
                </div>
            </div>
        </section>
        ...
        <section class="case-single-area pt-120 pb-120">
            <div class="container">
                ...
                <div class="image">
                    ...
                    <h3 class="case-single__title mt-40 mb-30">Contenidos marca blanca</h3>
                    <p>Nuestra solución ofrece formación virtual o combinada con una plataforma de administración en la nube que garantiza una educación de calidad y rápida implementación con su propia identidad visual. Contamos con un amplio catálogo de cursos interactivos multimedia, actualizados y compatibles con SCORM, cubriendo 25 temáticas sectoriales y transversales. Además, proporcionamos una herramienta de administración que permite matricular estudiantes, crear grupos y personalizar la experiencia de aprendizaje utilizando la imagen institucional. La plataforma es totalmente personalizable y los contenidos multimedia pueden integrarse en cualquier plataforma de e-learning del mercado, como Moodle, Canvas, Brightspace, entre otras, mediante licencia.</p>
                    
                   
                
                    <h3 class="case-single__title mt-40 mb-30">Contenidos a la medida</h3>
                    <p>Desarrollamos contenidos de educación virtual o combinada según las necesidades de su institución, con estándares SCORM. Nuestro equipo de expertos en educación y diseñadores instruccionales crea contenido en diversos formatos, incluyendo podcast, videos, juegos, realidad virtual y aumentada, y audio libros.</p>
                </div>
                <div class="row g-4 mt-10">
                    <div class="col-md-6">
                        <div class="image">
                            <img src="assets/images/case/contenido1.png" alt="image">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="image">
                            <img src="assets/images/case/marcablanca.jpg" alt="image">
                        </div>
                    </div>
                </div>
            </div>
