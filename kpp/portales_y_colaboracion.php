...
<body>
    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
            data-background="assets/images/banner/portales.jpg">
            <div class="shape2 wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/portales.png" alt="shape">
            </div>
            <div class="shape1 wow slideInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/portales.png" alt="shape">
            </div>
            <div class="shape3 wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img class="sway__animationX" src="assets/images/banner/portales.png" alt="shape">
            </div>
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Portales y colaboración</h2>
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.php">Inicio</a><span><i class="fa-regular fa-angles-right mx-2"></i>Portales y colaboración</span>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="about__left-item">
                            <div class="image big-image">
                                <img src="assets/images/about/share.png" alt="image">
                            </div>
                            <div class="image sm-image">
                                <div class="video__btn-wrp">
                                    
                                </div>
                                <img src="assets/images/about/sp.png" alt="image">
                            </div>
                    ...
                    <div class="col-xl-6">
                        <div class="section-header mb-40">
                            <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                ...
                                Portales y colaboración
                            </h5>
                            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Solución a la Congestión de Documentos y Fomento de la Eficiencia Empresarial</h2>
                            <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">Hoy en día no hay una respuesta para las bandejas de entrada obstruidas, interminables solicitudes de informes y empleados que no pueden encontrar respuestas sobre cómo cumplir con los procesos y procedimientos de la organización. Un portal de colaboración reduce las ineficiencias y congestión de documentos, así mismo fomenta la colaboración empresarial, la agilidad de los procesos y reduce los costos asociados a productividad.</p>
                        </div>
                        <div class="row g-4 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        <h4 class="mb-1">Reduce ineficiencias</h4>
                                        <p>Optimizando la productividad.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        <h4 class="mb-1">Fomenta la colaboración</h4>
                                        <p>Empresarial y agiliza los procesos internos.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="counter__wrp gradient-bg">
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            ...
                            <p class="text-white">Centralizada</p>
                        </div>
                    </div>
                    <div class="counter__item wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            ...
                            <p class="text-white">Del conociminento</p>
                        </div>
                    </div>
                    <div class="counter__item wow bounceInUp" data-wow-delay="800ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            <h3><span>Colaboración</span></h3>
                            <p class="text-white">En tiempo real</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <h4><a href="service-details.html">Fomenta la cohesión y eficiencia con intranet</a></h4>
                            <p>comparte recursos y noticias personalizadas en portales y aplicaciones móviles.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <div class="service__item active">
                            ...
                            <h4><a href="service-details.html">Impulsa la productividad con SharePoint</a></h4>
                            <p>simplifica desde notificaciones hasta flujos de trabajo complejos, creando soluciones digitales personalizadas.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <h4><a href="service-details.html">Fomenta la colaboración</a></h4>
                            <p>SharePoint permite el trabajo en equipo a través de espacios compartidos, facilitando la cooperación en proyectos y la comunicación efectiva entre colegas.</p>
                        </div>
                    </div>
                </div>
            </div>
