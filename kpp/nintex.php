    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
            ...
            <div class="shape2 wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/nintex.jpg" alt="shape">
            </div>
            <div class="shape1 wow slideInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/nintex.jpg" alt="shape">
            </div>
            <div class="shape3 wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img class="sway__animationX" src="assets/images/banner/nintex.jpg" alt="shape">
            </div>
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Nintex</h2>
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.php">Inicio</a><span><i class="fa-regular fa-angles-right mx-2"></i>Nintex</span>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <h4><a href="service-details.html">Eficiencia escalable</a></h4>
                            <p>Un sistema que permite una reducción de costos significativa al escalar fácilmente para adaptarse a las necesidades cambiantes, manteniendo un rendimiento óptimo sin aumentar desproporcionadamente los recursos.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <div class="service__item active">
                            ...
                            <h4><a href="service-details.html">Seguridad integrada</a></h4>
                            <p>Incorporación de medidas de seguridad y privacidad desde la concepción del sistema, garantizando la protección de los datos y la confidencialidad de los usuarios sin comprometer la usabilidad o la accesibilidad.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <h4><a href="service-details.html">Experiencia de usuario intuitiva</a></h4>
                            <p>Diseño centrado en el usuario que garantiza una experiencia fluida y fácil de usar, permitiendo una interacción intuitiva y sin complicaciones para usuarios de todos los niveles de habilidad.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-6">
                        <div class="section-header mb-40">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Supervisión remota fácil y segura con eProctoring.


                            </h2>
                            <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">eProctoring ofrece una supervisión remota eficiente y segura para evaluaciones en línea. Detecta múltiples usuarios, la ausencia de estos, y cualquier intento de cubrir o rechazar la webcam. Controla el uso de recursos y dispositivos, evita la navegación no autorizada y el copiado/pegado, y registra sonidos inesperados. Además, permite la revisión de grabaciones y ofrece vistas detalladas del entorno de trabajo, incluyendo ángulos adicionales para una observación más completa del estudiante.</p>
                        </div>
                        <div class="row g-4 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        <h4 class="mb-1">Supervisión</h4>
                                        <p>Remota segura y eficiente</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Completo y detección avanzada</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="counter__wrp gradient-bg">
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            <h3><span>Reducción</span></h3>
                            <p class="text-white"> De costo y
                                escalable</p>
                        </div>
                    </div>
                    <div class="counter__item wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            <h3><span >Bajo</span></h3>
                            <p class="text-white">Consumo de Internet</p>
                        </div>
                    </div>
                    <div class="counter__item wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            <h3><span >Seguridad</span></h3>
                            <p class="text-white">Y privacidad
                                por diseño</p>
                        </div>
                    </div>
                        ...
                        <div class="service-two__item">
                            ...
                            <div class="service-two__content">
                                ...
                                <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                        alt="shape"></div>
                                <h4><a href="service-details.html" class="primary-hover">Proctor automático de webcam sin instalación                                </a></h4>
                                <p>
                                    Validación de identidad y conocimientos sin instalación adicional, accesible desde cualquier navegador y dispositivo</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-two__item">
                            ...
                            <div class="service-two__content">
                                ...
                                <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                        alt="shape"></div>
                                <h4><a href="service-details.html" class="primary-hover">Monitoreo de computadoras y webcams
                                </a></h4>
                                <p>Solución modular para evaluaciones con monitoreo de webcam, computadora, audio, validación de entorno 360° y opción de segunda cámara, adaptable a cualquier tipo de evaluación</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-two__item">
                            ...
                            <div class="service-two__content">
                                ...
                                <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                        alt="shape"></div>
                                <h4><a href="service-details.html" class="primary-hover">Fiabilidad reforzada con IA y supervisión humana</a></h4>
                                <p>
                                    Validación cruzada con IA y equipo humano: mayor fiabilidad y eficiencia en evaluaciones críticas.</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-two__item">
                            ...
                            <div class="service-two__content">
                                ...
                                <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                        alt="shape"></div>
                                <h4><a href="service-details.html" class="primary-hover">Control total del proceso en tus manos</a></h4>
                                <p>Monitoreo en tiempo real: control total y propiedad del proceso para organizaciones que priorizan la supervisión interna.</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-two__item">
                            ...
                            <div class="service-two__content">
                                ...
                                <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                        alt="shape"></div>
                                <h4><a href="service-details.html" class="primary-hover">Acceso flexible</a></h4>
                                <p>Permite la supervisión desde cualquier ubicación y en cualquier momento, facilitando la gestión remota y la adaptación a las necesidades cambiantes.</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="service-two__item">
                            ...
                            <div class="service-two__content">
                                ...
                                <div class="shape"><img src="assets/images/shape/service-two-item-shape.png"
                                        alt="shape"></div>
                                <h4><a href="service-details.html" class="primary-hover">Informes detallados</a></h4>
                                <p>Genera informes exhaustivos sobre la actividad supervisada, proporcionando análisis y datos útiles para la toma de decisiones y la mejora continua del proceso.</p>
