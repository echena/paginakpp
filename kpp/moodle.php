    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
            ...
            <div class="shape1 wow slideInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/moodle.jpg" alt="shape">
            </div>
            <div class="shape3 wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img class="sway__animationX" src="assets/images/banner/moodle.jpg" alt="shape">
            </div>
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Moodle</h2>
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.php">Inicio</a><span><i class="fa-regular fa-angles-right mx-2"></i>Moodle</span>
                </div>
            </div>
        </section>
                            ...
                            <div class="image mb-50">
                                ...
                                <div class="service-single__video-btn">
                                    <div class="video-btn video-pulse wow fadeIn" data-wow-delay="200ms"
                                        ...
                                        <a class="video-popup" href="https://youtu.be/DubiRbeDpnM"><i
                                                class="fa-solid fa-play"></i></a>
                                    </div>
                                </div>
                            </div>
                            <h3 class="title mb-30">
                                Cree comunidades de aprendizaje efectivas</h3>
                            <p class="mb-20">Es la plataforma virtual de aprendizaje (LMS) que ofrece mayor versatilidad y flexibilidad para sus proyectos formativos.</p>
                            <p class="mb-40">Ponemos a su disposición conocimiento y experiencia en Moodle. Le ayudamos a elegir el despliegue que mejor se adapte a sus circunstancias particulares</p>
                            
                            <div class="row g-5 mt-40 mb-40 align-items-center">
                                <div class="col-lg-5">
                                    <h4 class="mb-20">Características</h4>
                                    <ul>
                                        <li class="mb-15"><i class="fa-solid fa-check"></i>Instalación y migración Moodle</li>
                                        <li class="mb-15"><i class="fa-solid fa-check"></i>Integración con otras plataformas.</li>
                                        <li class="mb-15"><i class="fa-solid fa-check"></i>Actualización, mantenimiento, respaldo y seguridad para Moodle</li>
                                        <li class="mb-15"><i class="fa-solid fa-check"></i>Consultoría y asesoría Moodle</li>
                                    </ul>
                                </div>
                                <div class="col-lg-7">
                                    <div class="image">
                                        <img src="assets/images/service/moodle.jpg" alt="image">
                                    </div>
                                </div>
                            </div>
                            <p class="mb-40">Moodle ha sido diseñado siguiendo claros los principios pedagógicos basados aprendizaje colaborativo o constructivismo social. Su objetivo principal es llevar a las organizaciones a generar comunidades online de aprendizaje eficaces

                            </p>
                            <h3 class="title mb-30">Características</h3>
                            <p class="mb-30">Moodle como plataforma de gestión de aprendizaje es versátil y fácil de gestionar, entre algunas de sus características se pueden mencionar.</p>
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item wow fadeInDown shadow border-none" data-wow-delay="00ms"
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <p>Todo el ciclo de gestión de alumnos, creación de cursos, corrección de exámenes, se realiza por los usuarios, no es necesario personal técnico para su gestión o administración.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInDown shadow border-none" data-wow-delay="200ms"
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>Ponga a disposición de su organización una gran variedad de recursos formativos: foros, chats, diarios, cuestionarios, materiales, consultas, videos, encuestas, tareas, y mas de 200 recursos adicionales.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInDown shadow border-none" data-wow-delay="400ms"
                                    ...
                                    <div id="collapsethree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>Moodle es la plataforma de formación más extendida con más portales funcionando en 209 países, Es usada por numerosas organizaciones educativas, gubernamentales y privadas para prestar servicios de formación online a sus colaboradores, proveedores y clientes.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow fadeInDown shadow border-none" data-wow-delay="600ms"
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <p>Disponga de una plataforma de formación online. Con todas las ventajas derivadas de las sus distribuciones bajo licencia de Software Libre o Código Abierto.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 order-1 order-lg-2">
                        <div class="service-single__right-item">
                            <div class="item sub-bg mb-30">
                                <h4 class="mb-20">Beneficios de usar moodlex</h4>
                                <ul class="category service-category">
                                    <li><a href="#0">Flexibilidad</a> </li>
                                    <li><a href="#0">Accesibilidad</a> </li>
                                    <li class="active"><a href="#0">Colaboración</a> </li>
                                    <li><a href="#0">Seguimiento del progreso</a></li>
                                    <li><a href="#0">Comunidad de apoyo</a> </li>
                                </ul>
                            </div>
                            <div class="item sub-bg mb-30">
                                <h4 class="mb-20">Moodle destaca por</h4>
                                <ul class="category">
