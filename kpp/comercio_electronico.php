...
<body>
    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
            data-background="assets/images/banner/comercio.jpg">
            <div class="shape2 wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/comercio.jpg" alt="shape">
            </div>
            <div class="shape1 wow slideInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img src="assets/images/banner/comercio.jpg" alt="shape">
            </div>
            <div class="shape3 wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                <img class="sway__animationX" src="assets/images/banner/comercio.jpg" alt="shape">
            </div>
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Comercio electrónico</h2>
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.php">Inicio</a><span><i class="fa-regular fa-angles-right mx-2"></i>Comercio electrónico</span>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xl-6">
                        <div class="section-header mb-40">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Integración de Plataformas de Comercio Electrónico para Negocios Tradicionales</h2>
                            <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">Con nuestras soluciones de comercio electrónico, llevamos su negocio tradicional al mundo digital mediante plataformas de venta integradas. Desde la creación de tiendas en línea hasta la implementación de sistemas de pago seguros, ofrecemos una solución completa para que su empresa pueda expandirse y alcanzar nuevos clientes en el mercado en línea. Maximice su alcance y aumente sus ventas con nuestra experiencia en comercio electrónico.</p>
                        </div>
                        <div class="row g-4 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        <h4 class="mb-1">Integración</h4>
                                        <p>Con el negocio tradicional.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="about__right-item">
                                    ...
                                    <div class="content">
                                        <h4 class="mb-1">Ampliación</h4>
                                        <p>Del alcance de ventas en línea.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="counter__wrp gradient-bg">
                    ...
                    <div class="counter__item wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            <h3><span>Accesibilidad</span></h3>
                            <p class="text-white">Global</p>
                        </div>
                    </div>
                    <div class="counter__item wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            <h3><span>Experiencias</span></h3>
                            <p class="text-white">Adaptadas</p>
                        </div>
                    </div>
                    <div class="counter__item wow bounceInUp" data-wow-delay="800ms" data-wow-duration="1000ms">
                        ...
                        <div class="content">
                            ...
                            <p class="text-white">Garantizada</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <h4><a href="service-details.html">Implementación</a></h4>
                            <p>Diseño y desarrollo de plataformas de comercio electrónico, con enfoque en diseño web receptivo y estándares de seguridad, como PCI-DSS y PA-DSS.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="200ms" data-wow-duration="1000ms">
                        <div class="service__item active">
                            ...
                            <h4><a href="service-details.html">CMS</a></h4>
                            <p>Desarrollo personalizado de CMS y comercio electrónico, incluyendo personalización de contenidos, precios y UX basada en perfiles, ubicación e historial del usuario.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
                        <div class="service__item">
                            ...
                            <p>Potencie sus ventas y visibilidad con estrategias digitales: SEO, SEM, blog, redes sociales, email marketing, publicidad digital y análisis web.</p>
                        </div>
                    </div>
                </div>
            </div>
